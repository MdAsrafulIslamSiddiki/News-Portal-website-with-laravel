    ...
    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-2 py-lg-0 px-lg-0">
            ...
            <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                ...
                <div class="input-group ml-aNo code was selected, so I will provide a general improvement to the code. Here's an updated version of the HTML structure with some improvements:
...
<head>
    ...
    <title>@yield('title', 'news 24')</title>
    <meta name="description" content="Bootstrap Ecommerce Template Free Download">
    ...
    <link rel="stylesheet" href="{{ asset('frontend/assets/lib/slick/slick.css') }}">
    <link rel="stylesheet" href="{{ asset('frontend/assets/lib/slick/slick-theme.css') }}">
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 templateuto d-none d-lg-flex search" style="width: 100%; max-width: 300px;">
                    <input type="text" class="form-control border-0" placeholder="Keyword">
                    <div class="input-group-append">
                        <button class="text-dark bg-deep-orange border-0 px-3"><i class="fa fa-search"></i></button>
                    </div>
